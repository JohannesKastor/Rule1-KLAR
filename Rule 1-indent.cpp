...
int winamount = 0;    //Detta står för "total win amount".
...
{ 
  ...
  {
    blc = blc + bet + (bet * 30);
    winamount = winamount + bet + (bet * 30);
...
{
  blc = blc + bet + (bet * 10);
  winamount = winamount + bet + (bet * 10);
  ...
  cout << "Total winning amount:   " <<winamount;
  cout <<endl;
